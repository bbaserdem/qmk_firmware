 ...
 */
#define WAH_WAH \
    QD_NOTE(_B2), QD_NOTE(_D3), Q__NOTE(_E3), Q_NOTE(_FS3), \
    QD_NOTE(_B2), QD_NOTE(_D3), Q__NOTE(_E3), Q_NOTE(_FS3), \
    S__NOTE(_A3), ED_NOTE(_B3), QD_NOTE(_A3), Q__NOTE(_GS3), Q_NOTE(_A3), \
    QD_NOTE(_B3), QD_NOTE(_A3), Q__NOTE(_GS3), Q_NOTE(_A3), \
