    ...
    if (index == 0) {
        ...
        switch (biton32(layer_state)) {
            ...
            case _NUMB:
                ...
                break;
            case _SYMB:
                // Symbol layer; insert lines/delete characters
                if (clockwise) {
                    tap_code(KC_ENT);
                } else {
                    tap_code(KC_BSPC);
            ...
            case _FUNC:
                ...
                break;
            case _NAVG:
                // Navigation layer; scroll pointer laterally
                if (clockwise) {
                    tap_code(KC_WH_R);
                } else {
                    tap_code(KC_WH_L);
            ...
            case _MOUS:
                ...
                break;
            case _MEDI:
                // Media layer; increase/decrease rgb hue
                if (clockwise) {
                    tap_code(RGB_HUI);
                } else {
                    tap_code(RGB_HUD);
