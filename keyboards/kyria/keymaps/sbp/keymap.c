...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MEDI] = LAYOUT_wrapper(
        ...
        RGB_TOG,_ME4_3_,_______,_______,___3___,RGB_M_R	
    ),
    ...
    [_MOUS] = LAYOUT_wrapper(
        ...
        KC_BTN3,_MO4_3_,_______,_______,___3___,KC_BTN4
    ),
